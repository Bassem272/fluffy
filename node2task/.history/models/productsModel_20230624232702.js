...
async updateCategory(id, updatedFields) {
  try {
    ...
    caproduct.name = updatedFields.name || caproduct.name;
   // product.price = updatedFields.price || caproduct.price;
    caproduct.updatedAt = new Date();
    console.log("Fetched data:", caproduct);
    return caproduct;
  } catch (error) {
    // Handle any errors that occur during the fetch request
    console.error("Error fetching updated pca data:", error);
    return null;
  }
},
