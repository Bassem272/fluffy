...
async updateCategory(id, updatedFields) {
  try {
    ...
    categoryprod.name = updatedFields.name || categoryprod.name;
   // product.price = updatedFields.price || categoryprod.price;
    categoryprod.updatedAt = new Date();
    console.log("Fetched data:", categoryprod);
    return categoryprod;
  } catch (error) {
    // Handle any errors that occur during the fetch request
    console.error("Error fetching updated pcateg data:", error);
    return null;
  }
},
