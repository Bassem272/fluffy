...
async updateCategory(id, updatedFields) {
  try {
    ...
    categoryproduct.name = updatedFields.name || categoryproduct.name;
   // product.price = updatedFields.price || categoryproduct.price;
    categoryproduct.updatedAt = new Date();
    console.log("Fetched data:", categoryproduct);
    return categoryproduct;
  } catch (error) {
    // Handle any errors that occur during the fetch request
    console.error("Error fetching updated pcategory data:", error);
    return null;
  }
},
