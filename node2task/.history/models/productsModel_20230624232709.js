...
async updateCategory(id, updatedFields) {
  try {
    ...
    categoproduct.name = updatedFields.name || categoproduct.name;
   // product.price = updatedFields.price || categoproduct.price;
    categoproduct.updatedAt = new Date();
    console.log("Fetched data:", categoproduct);
    return categoproduct;
  } catch (error) {
    // Handle any errors that occur during the fetch request
    console.error("Error fetching updated pcatego data:", error);
    return null;
  }
},
async deleteCategory(id) {
  try {
    // Fetch the updated product data from an external API or source
    const products = await this.readCategories();
    console.log(products, "yuit");
    ...
    console.log("Fetched data:", product.id);
    console.log("Fetched data:", product.name);
    console.log("Fetched data:", updatedFields.name);
    console.log("Fetched data:", updatedFields.id);

    // Update the product fields with the fetched data or use the existing values
    product.name = updatedFields.name || product.name;
