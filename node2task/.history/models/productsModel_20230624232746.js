...
async updateCategory(id, updatedFields) {
  try {
    ...
    categor.name = updatedFields.name || categor.name;
   // product.price = updatedFields.price || categor.price;
    categor.updatedAt = new Date();
    console.log("Fetched data:", categor);
    return categor;
  } catch (error) {
    // Handle any errors that occur during the fetch request
    console.error("Error fetching updated p data:", error);
    return null;
  }
},
