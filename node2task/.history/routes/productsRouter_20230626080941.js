...
router.get("/products",productsModel.authenticateToken, productsModel.userAuthorization,productController.getAllProducts);
router.get("/products/:id", productsModel.authenticateToken,productsModel.userAuthorization,productController.getProductById);
