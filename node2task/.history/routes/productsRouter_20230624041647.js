...
router.post ("/category",productsMod.authenticateToken, productController.getAllProducts);
router.get("/category/:id",productsMod.authenticateToken, productController.getAllProducts);
