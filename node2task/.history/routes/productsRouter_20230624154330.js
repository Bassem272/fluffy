...
router.get ("/category",productsMod.authenticateToken, productController.getACategories);
router.get("/category/:id",productsMod.authenticateToken, productController.putCategory);
