...
router.put("/products/:id",productsModel.adminAuthorization, productController.updateProduct);
router.delete("/products/:id", productsModel.adminAuthorization,productController.deleteProduct);
