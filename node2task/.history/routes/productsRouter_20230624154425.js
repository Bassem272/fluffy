...
router.get("/category/:id",productsMod.authenticateToken, productController.getCategory);
router.delete("/category/:id",productsMod.authenticateToken, productController.deleteCategoryCategory);
