...
export default {
  ...
  async getAllProducts(req, res) {
    try {
      ...
      productsModel.setProducts(data);// save it to products array in productsModel
      // fs.writeFile('output.json',JSON.stringify(data));
      res.json(productsModel.saveProducts());// save the data to output.json file 
    } catch (error) {
  ...
  async getAllProducts(req, res) {
    try {
     ...
     fs.writeFile('/categories.json',JSON.stringify(category)
